...
// Usage: node run_engine_node.js <fixture.bin> <patches.json> <mode> <fov|null> <cull|null> <out.bin> [bpsOut]
const fs = require("fs");
const path = require("path");
const { applyPatches, makeBps } = require(path.join(__dirname, "..", "docs", "engine.js"));

const [, , fixture, manifestPath, mode, fovArg, cullArg, out, bpsOut] = process.argv;
...
applyPatches(manifest, buf, mode, { fov: fov, cull: cull });
